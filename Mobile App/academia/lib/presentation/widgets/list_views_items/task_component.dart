    ...
    Row(
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CustomText(text: AppStrings.remainingHours,
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                          fontSize: FontSize.s12,
                          color: ColorManager.lightError)),
                  const Spacer(),
                  CustomText(text: '${AppStrings.assignment} 01',
                      style:
              ...
              CustomText(text: assignment!.description,
      ...
      onTap: () {
                                      showCustomBottomSheet(
                                          context: context,
                                          bottomSheet:
                                             StartQuizBottomSheet(quiz: quiz!));
                                    },
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Spacer(),
                    CustomText(text: '${AppStrings.quiz} 01',
                        style:
                            Theme.of(context).textTheme.displayMedium!.copyWith(
                                  fontSize: FontSize.s16,
                                )),
