...
import 'bottom_nav_bar_screens/courses/Courses_cubit/courses_cubit.dart';
        ...
        return MultiBlocProvider(
          providers: [
            BlocProvider<CoursesCubit>.value(
              value: getItInstance<CoursesCubit>(),
            ),

            BlocProvider<AssignmentsCubit>.value(
              //lazy: false,
              value: getItInstance<AssignmentsCubit>()..getAssignments(),
            ), 
            BlocProvider<QuizCubit>.value(
              value: getItInstance<QuizCubit>()..getQuizes(),
            ),
          ],
