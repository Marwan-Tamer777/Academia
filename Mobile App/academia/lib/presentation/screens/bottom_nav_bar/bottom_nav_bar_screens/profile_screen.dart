                    ...
                    children: [
                      ListTile(
                        leading: Row(
                          ...
                          children: [
                            Text("تغيير اللغة", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),),
                        ...
                        title: Align(
                            ...
                            child: Text("تغيير اللغة", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),)),
                      ...
                      ListTile(
                        ...
                        title: Align(
                            alignment: Alignment.centerRight,
                            child: Text("الوضع الليلى", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),)),
                        trailing: CircleAvatar(
                          radius: 30,
                          backgroundColor: ColorManager.lightOrange1,
                      ...
                      ListTile(
                        ...
                        title: Align(
                            alignment: Alignment.centerRight,
                            child: Text("تغيير كلمة المرور", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),)),
                        trailing: CircleAvatar(
                          radius: 30,
                          backgroundColor: ColorManager.lightOrange1,
                      ...
                      ListTile(
                        ...
                        title: Align(
                            alignment: Alignment.centerRight,
                            child: Text("قيم تطبيقنا", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),)),
                        trailing: CircleAvatar(
                          radius: 30,
                          backgroundColor: ColorManager.lightOrange1,
                      ...
                      ListTile(
                        title: Align(
                            alignment: Alignment.centerRight,
                            child: Text("تسجيل الخروج", style: Theme.of(context).textTheme.displayMedium!.copyWith(fontSize: FontSize.s15, color: ColorManager.black),)),
                        trailing: CircleAvatar(
                          radius: 30,
                          backgroundColor: ColorManager.lightOrange1,
